...
Run `pnpm release` locally to publish a new version of `@kimuson/pi-auto`.
...
1. Open the npm package settings for `@kimuson/pi-auto`.
...
3. Rewrite the notes from the perspective of `@kimuson/pi-auto` users.
4. Publish the draft:
...
- This package is public and published as `@kimuson/pi-auto`.
