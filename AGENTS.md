...
pi-auto is a pi package that bundles extensions, skills, prompts, and themes for the pi coding agent. Resources are auto-discovered through convention directories and declared in the `pi` manifest.
